...
export const Step1ReceptorsScreen: React.FC = () => {
  ...
  // Clinical data values remain 'positive' | 'negative' for the store / rule engine.
  // Display labels are resolved via t() so they localise correctly (including RTL).
  ...
  return (
    <ScreenLayout
      ...
      subtitle={t('assessment:stepSubtitle', {
        current: 1,
        total: 3,
        title: t('receptors:stepTitle'),
      })}
...
const styles = StyleSheet.create({
  label: {
    ...
    marginTop: 9,
    marginBottom: 4,
    // Logical writing direction for RTL languages
