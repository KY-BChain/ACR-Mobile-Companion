...
console.log('PASS version/native consistency: Expo, Android, iOS and derived gateway build ID are 0.6.5 / 46; one compiled https origin and no cleartext exception on either platform');
