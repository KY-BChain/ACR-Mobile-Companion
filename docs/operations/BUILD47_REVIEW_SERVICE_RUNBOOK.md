...
Rebuild and reinstall over the existing app. The bundle identifier (`com.anonymous.acr-mobile-companion`) and team stay the same, so the Keychain session survives.
