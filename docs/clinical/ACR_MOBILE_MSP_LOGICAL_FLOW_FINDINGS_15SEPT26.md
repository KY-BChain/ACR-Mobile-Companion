...
- Prior records: `docs/clinical/ACR_Mobile_20_Fields_Reference_15SEPT26.md`; `docs/loop/ACR_MOBILE_BACKEND_REASONER_FLOW_REAFFIRMATION_v0.1.md`; `docs/build45-evidence/gate1/GATE1_EVIDENCE_T4501_T4502_20260909.md`.
